...
INSERT INTO store_tbl (sellerCode, storeName, storeCategory, storeImage, storeAddress, storePhone, zzimCount, reviewCount, storeRating, storeDescription, minOrderPrice, deliveryFee, operatingTime, deliveryArea, storeStatus)
VALUES
(20002, '맛있는 음식점2', '한식', 'store1.jpg', '서울시 강남구 강남대로 123', '02-1234-5678', 100, 50, 4.5, '맛있는 음식점입니다.', 15000, 3000, '10:00 - 22:00', '강남구', 0),
(20003, '맛있는 음식점3', '한식', 'store1.jpg', '서울시 강남구 강남대로 123', '02-1234-5678', 100, 50, 4.5, '맛있는 음식점입니다.', 15000, 3000, '10:00 - 22:00', '강남구', 1),
(20004, '맛있는 음식점4', '한식', 'store1.jpg', '서울시 강남구 강남대로 123', '02-1234-5678', 100, 50, 4.5, '맛있는 음식점입니다.', 15000, 3000, '10:00 - 22:00', '강남구', 1);

select * from store_tbl;


SELECT store_tbl.storeCode, store_tbl.storeName,
		store_tbl.storeStatus, GROUP_CONCAT(menu_tbl.menuName) AS menuNames
		FROM store_tbl
...
INSERT INTO menu_tbl (storeCode, menuName, menuPrice, menuImage, menuContent, menuClassification, menuStatus)
VALUES
(30006, '김치찌개', 9000, 'menu1.jpg', '맛있는 김치찌개', '찌개', 0),
(30006, '된장찌개', 8500, 'menu2.jpg', '향긋한 된장찌개', '찌개', 0),
(30006, '불고기', 12000, 'menu3.jpg', '매콤한 불고기', '고기요리', 0),
(30007, '김치찌개', 9000, 'menu1.jpg', '맛있는 김치찌개', '찌개', 0),
(30007, '된장찌개', 8500, 'menu2.jpg', '향긋한 된장찌개', '찌개', 0),
(30007, '불고기', 12000, 'menu3.jpg', '매콤한 불고기', '고기요리', 0),
(30008, '김치찌개', 9000, 'menu1.jpg', '맛있는 김치찌개', '찌개', 0),
(30008, '된장찌개', 8500, 'menu2.jpg', '향긋한 된장찌개', '찌개', 0),
(30008, '불고기', 12000, 'menu3.jpg', '매콤한 불고기', '고기요리', 0);
