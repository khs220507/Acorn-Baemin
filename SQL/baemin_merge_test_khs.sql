...
VALUES
('user１', 30001, 40001, 50001, 2, 21000, 1),
('user１', 30002, 40002, 50002, 1, 20000, 1),
('user１', 30003, 40003, 50003, 3, 24000, 1),
('user１', 30004, 40004, 50004, 2, 54000, 1),
('user１', 30005, 40005, 50005, 1, 9000, 1);
