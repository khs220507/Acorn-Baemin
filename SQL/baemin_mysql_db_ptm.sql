...
create table seller_tbl(
    ...
    sellerId varchar(20) unique not null,
...
(123456, 'seller1', 'password1', 'Seller One', '555-111-2222', 'seller1@example.com', '1980-07-10', 0, 1),
(748370, 'seller2', 'password2', 'Seller Two', '555-222-3333', 'seller2@example.com', '1975-05-20', 1, 1),
(485906, 'seller3', 'password3', 'Seller Three', '555-333-4444', 'seller3@example.com', '1990-12-05', 0, 1),
(574522, 'seller4', 'password4', 'Seller Four', '555-444-5555', 'seller4@example.com', '1988-03-15', 1, 1),
(884625, 'seller5', 'password5', 'Seller Five', '555-555-6666', 'seller5@example.com', '1995-01-25', 0, 1);
